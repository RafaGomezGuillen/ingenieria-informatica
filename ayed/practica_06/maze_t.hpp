...
#include "dll_t.hpp"  //para guardar la solución
...
class maze_t {
 private:
  ...
  // lista que almacena la solucion
  dll_t<char> lista;

  int contador_backtrack;
 ...
 public:
  ...
  // metodo para resolver el laberinto y que invoca al otro metodo recursivo
  bool solve(void);

  // FASE III: metodo que saca la solucion por pantalla
  void maze_path(void);
