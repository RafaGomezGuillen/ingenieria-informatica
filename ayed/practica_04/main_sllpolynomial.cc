...
int main() {
  ...
  cout << "Eliminar ultimo y primer monomio: \n";
  cout << "sllp1= " << sllp1;
  cout << sllp1.EliminarUltimoYPrimerMonomio();
  cout << "sllp2= " << sllp2;
  cout << sllp2.EliminarUltimoYPrimerMonomio();
  cout << "sllp3= " << sllp3;
  cout << sllp3.EliminarUltimoYPrimerMonomio();
